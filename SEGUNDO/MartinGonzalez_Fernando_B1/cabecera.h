...
class Instituto{
	...
	public:
		...
		//TODO a)
		// Operador =
		Instituto operator=(Instituto& i);
		// Operador <, por orden descendete de nombre
		bool operator<(Instituto const & i);
...
list<Instituto> getInstitutoMayorProfesores(set<Instituto>);

// TODO d) map <string, float> getCiudadRatio(...);
map<string, float> getCiudadRatio(set<Instituto>);
